...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "IRR" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/9bae70222765fc50c371ab95/latest/${fromCurrency.value}`;
